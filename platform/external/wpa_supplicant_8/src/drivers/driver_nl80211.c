...
#endif
		wpa_printf(MSG_DEBUG, " * Set 11111111111111111111111111111111\n");
...
wpa_printf(MSG_DEBUG, "nl80211: nl80211_set_conn_keys nl80211_set_conn_keys nl80211_set_conn_keys \n");
	ret = nl80211_set_conn_keys(params, msg);
	if (ret)
		goto nla_put_failure;
...
nla_put_failure:
	wpa_printf(MSG_DEBUG, "nl80211: nla_put_failure: nla_put_failure\n");
	nlmsg_free(msg);
	return ret;

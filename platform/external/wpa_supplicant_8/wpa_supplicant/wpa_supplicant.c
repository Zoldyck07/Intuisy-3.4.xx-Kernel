...
//		ssid->proto = 3;
//                wpa_printf(MSG_DEBUG, "## WAPI Info : ssid->wapi %d ssid->proto %d ssid->key_mgmt %d @@\n\n\n", ssid->wapi, ssid->proto, ssid->key_mgmt);
...
#if 0
                 wpa_s->assoc_wapi_ie_len =  global->ifaces->assoc_wapi_ie_len;
		                wpa_printf(MSG_DEBUG, "===============> %s: params.wpa_ie_len=%d\n",
						                        __FUNCTION__, wpa_s->assoc_wapi_ie_len);
				                memcpy(wpa_s->assoc_wapi_ie,global->ifaces->assoc_wapi_ie,wpa_s->assoc_wapi_ie_len); /* to do: do I have to manually copy the contents into params.wpa_ie? */
